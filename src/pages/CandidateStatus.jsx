...
export default function CandidateStatus() {
  ...
  const interviewsFor = (applicationId) =>
    interviews
      ...
      .sort(
        (a, b) =>
          (a.interview_stages?.sort_order ?? 0) - (b.interview_stages?.sort_order ?? 0)
      );
    ...
    <div className="max-w-4xl mx-auto px-5 py-12">
      ...
      {!loading && applications.length === 0 && (
        <div className="card p-10 text-center">
          ...
          <Link to="/" className="btn-primary">Browse Open Jobs</Link>
        </div>
      )}
                    ...
                    return (
                      <div
                        ...
                        className={`rounded-xl border px-4 py-3 ${
                          upcoming ? "border-gold/40 bg-gold/5" : "border-ink/10"
                        }`}
                      >
                        ...
                        {upcoming && (
                          <p className="text-xs text-ink/40 mt-2">
                            The join link opens at the scheduled time. Add it to your calendar so
                            you don't miss it.
                          </p>
                        )}
                      </div>
